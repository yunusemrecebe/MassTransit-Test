...
{
    public class LoadingInstructionCreatedConsumerDefinition : ConsumerDefinitionBase<AsisMassTransitConsumerDecorator<LoadingInstructionCreatedConsumer,LoadingInstructionCreatedEventModel>>
    {
